...
namespace LojaCarrosV2.PainelWeb.Controllers
{
    ...
    public class ClienteController : BaseController
    {
        ...
        public ActionResult Index(string q, int? pagina, string so, string cs, int? pt, BuscaModel model)
        {
            ...
            model.Termo = q;
            var lista = clienteDal.Listar(model.Termo, UsuarioCorrente().IdEmpresa);
        ...
        public ActionResult Cadastro(ClienteVM model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    cliente.IdEmpresa = UsuarioCorrente().IdEmpresa;
        ...
        public ActionResult Editar(int id)
        {
            ...
            var cliente = clienteDal.ListarPorId(id, UsuarioCorrente().IdEmpresa);
            if (cliente != null)
            {
